...
class ComicRepository {
  ...
  /// Get popular comics
  Future<List<ComicItem>> getPopular() => _comicService.getPopularComics();

  /// Get trending comics
  Future<List<ComicItem>> getTrending() => _comicService.getTrendingComics();
  ...
  Future<List<ComicItem>> getTopRated() => _comicService.getTopRatedComics();
  ...
  /// Get seasonal comics
  Future<List<ComicItem>> getSeasonal() => _comicService.getSeasonalComics();
}
