              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SectionTitle('Featured Titles'),
                    ...
                    const SizedBox(height: 24),
                    const SectionTitle('Popular This Week'),
                    const SizedBox(height: 8),
                    _HorizontalStrip(
                      height: 200,
...
// Replaced by SectionTitle in widgets/common.dart
        ...
        itemBuilder: (context, i) => Container(
          ...
          child: ClipRRect(
            ...
            child: Stack(
              fit: StackFit.expand,
              children: [
                Container(color: const Color(0xFF232730)),
                Positioned(
                  left: 12,
                  right: 12,
                  bottom: 12,
